...
class IntelligentMemoryProvider(MemoryProvider):
    ...
    def __init__(
        ...
        *,
        ...
        self.cloud_mode = str(self.config.get("cloud_mode", "selective")).lower()
        self.max_recall_facts = max(1, min(20, int(self.config.get("max_recall_facts", 6))))
        self.max_recall_chars = max(200, int(self.config.get("max_recall_chars", 1800)))
    ...
    def get_tool_schemas(self) -> list[dict[str, Any]]:
        return [REMEMBER_SCHEMA, RECALL_SCHEMA, STATUS_SCHEMA]
